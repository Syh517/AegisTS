...
def prepare_trained_model(
    local_zip_path='/home/yyy/TSC/TSClean/baselines/metaod/saved_models/trained_models.zip',
    ...
    if not os.path.exists(local_zip_path):
        raise FileNotFoundError(f"local ZIP file dose not exist: {local_zip_path}\n")
