...
from Error_Detection.detectors.utils.torch_utility import get_gpu
...
class AnomalyTransformer():
    def __init__(self, 
        ...
        self.model = AnomalyTransformerModel(win_size=self.win_size, enc_in=self.input_c, c_out=self.output_c, e_layers=3).to(self.device)
