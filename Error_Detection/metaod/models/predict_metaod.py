...
from Error_Detection.metaod.models.utility import fix_nan
from pyod.utils.data import generate_data
...
trained_model_location = "/home/yyy/TSC/TSClean/AutoClean/Error_Detection/metaod/models/trained_models_0"

def select_model(X, trained_model_location=trained_model_location, n_selection=1):
...
if __name__ == "__main__":
    ...
    filepath = "/home/yyy/TSC/TSClean/AutoClean/Error_Detection/Train_Datasets/CalIt2/CalIt2_traffic_val.csv"
    df = pd.read_csv(filepath).dropna()
    X_train = df.iloc[:, 1:-1].values.astype(float)
