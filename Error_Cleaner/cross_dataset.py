...
if __name__ == '__main__':
    ...
    base_task_type = 'forecast'
    base_dataset = 'ETTh1'
    model_save_path = f"/home/yyy/TSC/TSClean/AutoClean/Error_Cleaner/saved_models/original/{base_task_type}_{base_dataset}_original_5.pkl"
