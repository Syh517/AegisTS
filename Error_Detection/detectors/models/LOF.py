...
from Error_Detection.detectors.utils.utility import invert_order
from Error_Detection.detectors.utils.utility import zscore
...
class LOF(BaseDetector):
    ...
    def __init__(self, slidingWindow=20, sub=True, n_neighbors=20, algorithm='auto', leaf_size=30,
