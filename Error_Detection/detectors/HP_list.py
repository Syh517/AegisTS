...
Optimal_Uni_algo_HP_dict = {
    ...
    'FFT': {},
    'Left_STAMPi': {},
    'AutoEncoder': {'window_size': 20, 'hidden_neurons': [128, 64]},
    'CNN': {'window_size': 20, 'num_channel': [32, 32, 40]},
    'LSTMAD': {'window_size': 20, 'lr': 0.0008},  
    'TranAD': {'win_size': 10, 'lr': 0.0001},
    'AnomalyTransformer': {'win_size': 20, 'lr': 0.001},  
    ...
    'COF': {'n_neighbors': 30},
    'EIF': {'n_trees': 50},  
    'KMeansAD': {'n_clusters': 10, 'window_size': 20},
    'KNN': {'n_neighbors': 50, 'method': 'mean'}, 
    'HBOS': {'n_bins': 30, 'tol': 0.5},
    'PCA': {'n_components': 0.25}, 
}
...
algo_HP_dict = {
    'Sub_IForest': {'periodicity': 1, 'n_estimators': 150},
    'IForest': {'slidingWindow': 20, 'n_estimators': 100},
    'Sub_LOF': {'periodicity': 2, 'n_neighbors': 30},
    'LOF': {'n_neighbors': 50},
    'Sub_PCA': {'periodicity': 1, 'n_components': None},
    'PCA': {'n_components': 0.25},         
    ...
    'RobustPCA': {'max_iter': 1000},
    'FFT': {'keep_ratio': 0.1},
    'NORMA': {'kernel': 'rbf', 'gamma': 0.1, 'eta': 0.01, 'lam': 1e-4},
    'Series2Graph': {'window': 10, 'hidden_dim': 32, 'lr': 1e-3, 'epochs': 50},

    # 平滑方法
    'MovingAverage': {'window': 5},
    'EWMA': {'alpha': 0.3},
    'SavGol': {'window': 7, 'poly': 2},
    'Kalman': {},
    'LOESS': {'frac': 0.3},
    'HoltWinters': {'alpha': 0.3, 'beta': 0.1},
    'RollingMedian': {'window': 5},
    ...
    'Mahalanobis': {},
    'HotellingT2': {},
    'PCAStat': {'n_components': 2},
    'KDE': {'bandwidth': 1.0},
    'GMM': {'n_components': 2},

    # 新添加方法
    'SARAD': {'window_size': 32, 'd_model': 64},
    'SensitiveHUE': {'window_size': 32,},
    'SensorSCAN': {'window_size': 32,},
    'CATCH': {'window_size': 32, 'patch_len': 8},
    'DADA': {'window_size': 32},
