...
class RLCleanEnvironment:
    def __init__(self, dirty_data, label, task_type, detector, constraints, concentrated=True, max_steps=20, train_ratio=0.7):
        ...
        self.total_cost = 0.0
        self.final_train_time_last = 0.0
        self.k_history = []
        self.best_k = 2
        # 初始化缓存检测结果
        ...
        self.last_test_perf = self.initial_final_perf
        self.prev_test_perf = self.initial_final_perf
    ...
    def step_high(self, macro_action, low_reward, is_final=False):
        ...
        final_perf, cur_time = train_and_evaluate(self.task_type, 'final', self.final_model, self)
        test_perf_change = final_perf - self.prev_test_perf
        ...
        time_inc = cur_time - self.final_train_time_last
        ...
        self.last_test_perf = final_perf
        
        self.final_train_time_last = cur_time
...
if __name__ == '__main__':
    ...
    model_save_path = f"/home/yyy/TSC/TSClean/AutoClean/Error_Cleaner/saved_models/final_model/{task_type}_{dataset_name}_final_model_5.pkl"
