...
from Error_Detection.detectors.utils.utility import check_parameter, get_optimal_n_bins, invert_order
...
class HBOS(BaseDetector):
    ...
    def __init__(self, slidingWindow=20, sub=True, n_bins=10, alpha=0.1, tol=0.5, contamination=0.1, normalize=True):
