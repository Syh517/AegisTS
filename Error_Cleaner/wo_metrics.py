...
# 常量
# ==============================
LAMBDA_1, LAMBDA_2, LAMBDA_3, LAMBDA_4 = 0.7, 0.05, 0, 0.25  # LAMBDA_1 * R_Perf_N - LAMBDA_2 * R_Cost_N + LAMBDA_3 * R_Issue_N + LAMBDA_4 * low_reward_N
LAMBDA_GRAD = 10.0  # Finish权重
ALPHA = 0.1 # k
...
if __name__ == '__main__':
    ...
    model_save_path = f"/home/yyy/TSC/TSClean/AutoClean/Error_Cleaner/saved_models/wo_metrics/{task_type}_{dataset_name}_wo_metrics_5.pkl"
